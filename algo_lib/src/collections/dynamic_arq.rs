...
//!
//! So far I did not find it very useful because if I do updats on 1e8 size tree
//! it consumes like a gigabyte of memory.
//! Also it doesn't work with negative numbers despite arguments are i64
//! It's around 2x slower than StaticArq.
